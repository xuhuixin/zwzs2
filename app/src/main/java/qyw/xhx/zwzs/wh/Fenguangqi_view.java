...
public class Fenguangqi_view extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fenguangqi_layout);
        //接收传值
...
//                ponkou=oltport.getUSER_LABEL();
                Toast.makeText(Fenguangqi_view.this,fenguangqi.getINT_ID(),Toast.LENGTH_SHORT).show();
                //跳转House_view.class
                Intent intent = new Intent(Fenguangqi_view.this,House_view.class);
        ...
        HttpUtil.sendOkHttpRequest(address, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if ("".equals(responseText)){
                    Toast.makeText(Fenguangqi_view.this, "未查询到数据", Toast.LENGTH_SHORT).show();
                }
                else {
                 ...
                 if (result) {
                     ...
                     Fenguangqi_view.this.runOnUiThread(new Runnable() {
                         @Override
                         public void run() {
                             closeProgressDialog();
//                            Adapter.notifyDataSetChanged();
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Fenguangqi_view.this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        closeProgressDialog();
                        Toast.makeText(Fenguangqi_view.this, "加载失败", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
...
//            Log.d("MainActivity", "COUNTY_ID is " + county.getCOUNTY_ID());
    ...
    private void showProgressDialog() {
        if (progressDialog == null) {
            progressDialog = new ProgressDialog(Fenguangqi_view.this);
