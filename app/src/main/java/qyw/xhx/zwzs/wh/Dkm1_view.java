...
public class Dkm1_view extends AppCompatActivity {
...
//
        dkmbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (id.equals("")){
                    Toast.makeText(Dkm1_view.this, "输入数据为空", Toast.LENGTH_SHORT).show();
                }else{
                    initData(id);
                    mListView.setVisibility(View.VISIBLE);
                    Toast.makeText(Dkm1_view.this, "有输入", Toast.LENGTH_SHORT).show();
                }
            }
        });
        saomiaobtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Dkm1_view.this,CommonScanActivity.class);
        ...
        if (pwd.equals("")){
//            Toast.makeText(Dkm_view.this, "扫描无数据", Toast.LENGTH_SHORT).show();
        }else{
            initData1(pwd);
            mListView.setVisibility(View.VISIBLE);
            Toast.makeText(Dkm1_view.this, "扫描有输入,正在检索..."+pwd, Toast.LENGTH_SHORT).show();
        }
    }
    //方法：初始化View
...
//        pwd=dkmeditText.getText().toString();
        url="https://ai.iorai.com/webservice/newjk.ashx?type=khsl_new&id="+id+"&key="+key;
        queryFromServer(url,"county");
    }
    private void initData1(String pwd) {
//        mDatas = new ArrayList<Dkm>();
        SimpleDateFormat format = new SimpleDateFormat("yyyyMMdd");
        key=Md5Utils.md5("khsl"+format.format(new Date()));
        url="https://ai.iorai.com/webservice/newjk.ashx?type=khsl_new1&id="+pwd+"&key="+key;
        queryFromServer(url,"county");
    }
...
//                    打印一下
                    ...
                    //跳转Zone_view.class
                    Intent intent = new Intent(Dkm1_view.this,Cover_view.class);
        ...
        HttpUtil.sendOkHttpRequest(address, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if ("[]".equals(responseText)){
                    Dkm1_view.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            closeProgressDialog();
                            Toast.makeText(Dkm1_view.this, "未查询到数据", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                else {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Dkm1_view.this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        closeProgressDialog();
                        Toast.makeText(Dkm1_view.this, "加载失败", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
...
//            mDatas.add(dkm);
    ...
    private void showProgressDialog() {
        if (progressDialog == null) {
            progressDialog = new ProgressDialog(Dkm1_view.this);
