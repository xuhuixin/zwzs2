...
//                    打印一下
                    ...
                    //跳转Zone_view.class
                    Intent intent = new Intent(Saomiao_view.this,Cover_view.class);
        ...
        HttpUtil.sendOkHttpRequest(address, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if ("[]".equals(responseText)){
                    Saomiao_view.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            closeProgressDialog();
                            Toast.makeText(Saomiao_view.this, "未查询到数据", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                else {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Saomiao_view.this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        closeProgressDialog();
                        Toast.makeText(Saomiao_view.this, "加载失败", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
...
//            mDatas.add(dkm);
    ...
    private void showProgressDialog() {
        if (progressDialog == null) {
            progressDialog = new ProgressDialog(Saomiao_view.this);
