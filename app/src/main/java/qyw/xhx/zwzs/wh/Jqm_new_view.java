...
public class Jqm_new_view extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jqm_layout_new);
...
//        initData();
        ...
        dkmbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (id.equals("")){
                    Toast.makeText(Jqm_new_view.this, "输入数据为空", Toast.LENGTH_SHORT).show();
                }else{
                    initData(id);
                    listView.setVisibility(View.VISIBLE);
                    Toast.makeText(Jqm_new_view.this, "有输入", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void initData(String id) {
        ...
        queryFromServer(server_url+"?type=jqm_sheng1&id="+id+"&key="+key+"&city_id="+city_id, "county");
        Log.d("查询地址:",server_url+"?type=jqm_sheng1&id="+id+"&key="+key+"&city_id="+city_id);
        //为数据绑定适配器
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //跳转Dkm_view.class
                Intent intent = new Intent(Jqm_new_view.this,Dkm_view.class);
                intent.putExtra("flow_id",dkm_new.getFLOWID());
                intent.putExtra("title","鉴权码查询");
                startActivity(intent);
                Toast.makeText(Jqm_new_view.this,dkm_new.getFLOWID(),Toast.LENGTH_SHORT).show();
            }
        });
        ...
        HttpUtil.sendOkHttpRequest(address, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (!"".equals(responseText)) {
                    if ("[]".equals(responseText)){
                        Jqm_new_view.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                closeProgressDialog();
                                Toast.makeText(Jqm_new_view.this, "没有数据返回", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }else{
...
//                            Adapter.notifyDataSetChanged();
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Jqm_new_view.this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        closeProgressDialog();
                        Toast.makeText(Jqm_new_view.this, "加载失败", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
...
//            coverpos1= ("端口","宽带账号","状态","端口状态时间");
    ...
    private void showProgressDialog() {
        if (progressDialog == null) {
            progressDialog = new ProgressDialog(Jqm_new_view.this);
