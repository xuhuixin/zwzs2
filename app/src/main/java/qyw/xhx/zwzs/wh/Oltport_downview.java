...
public class Oltport_downview extends AppCompatActivity {
...
//        String key=Md5Utils.md5("khsl"+t);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(Oltport_downview.this,oltport.getINT_ID(),Toast.LENGTH_SHORT).show();
                //跳转Fenguangqi_view.class
                Intent intent = new Intent(Oltport_downview.this,Hw_pon_down_view.class);
        ...
        HttpUtil.sendOkHttpRequest(address, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if ("".equals(responseText)){
                    Toast.makeText(Oltport_downview.this, "未查询到数据", Toast.LENGTH_SHORT).show();
                }
                else {
                 ...
                 if (result) {
                     ...
                     Oltport_downview.this.runOnUiThread(new Runnable() {
                         @Override
                         public void run() {
                             closeProgressDialog();
//                            Adapter.notifyDataSetChanged();
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Oltport_downview.this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        closeProgressDialog();
                        Toast.makeText(Oltport_downview.this, "加载失败", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
...
//            Log.d("MainActivity", "COUNTY_ID is " + county.getCOUNTY_ID());
    ...
    private void showProgressDialog() {
        if (progressDialog == null) {
            progressDialog = new ProgressDialog(Oltport_downview.this);
