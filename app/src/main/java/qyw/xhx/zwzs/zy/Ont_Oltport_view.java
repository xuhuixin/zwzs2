...
import qyw.xhx.zwzs.wh.Fenguangqi_view;
import qyw.xhx.zwzs.wh.Oltport;
import qyw.xhx.zwzs.wh.OltportAdapter;

public class Ont_Oltport_view extends AppCompatActivity {
...
//        String key=Md5Utils.md5("khsl"+t);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(Ont_Oltport_view.this,oltport.getINT_ID(),Toast.LENGTH_SHORT).show();
                //跳转Fenguangqi_view.class
                Intent intent = new Intent(Ont_Oltport_view.this,Ont_Down_view.class);
        ...
        HttpUtil.sendOkHttpRequest(address, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if ("".equals(responseText)){
                    Toast.makeText(Ont_Oltport_view.this, "未查询到数据", Toast.LENGTH_SHORT).show();
                }
                else {
                 ...
                 if (result) {
                     ...
                     Ont_Oltport_view.this.runOnUiThread(new Runnable() {
                         @Override
                         public void run() {
                             closeProgressDialog();
//                            Adapter.notifyDataSetChanged();
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Ont_Oltport_view.this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        closeProgressDialog();
                        Toast.makeText(Ont_Oltport_view.this, "加载失败", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
...
//            Log.d("MainActivity", "COUNTY_ID is " + county.getCOUNTY_ID());
    ...
    private void showProgressDialog() {
        if (progressDialog == null) {
            progressDialog = new ProgressDialog(Ont_Oltport_view.this);
