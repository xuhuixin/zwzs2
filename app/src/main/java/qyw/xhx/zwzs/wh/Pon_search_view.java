...
public class Pon_search_view extends AppCompatActivity {
        ...
        HttpUtil.sendOkHttpRequest(address, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if ("".equals(responseText)){
                    Toast.makeText(Pon_search_view.this, "未查询到数据", Toast.LENGTH_SHORT).show();
                }
                else {
...
//                            Adapter.notifyDataSetChanged();
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Pon_search_view.this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        closeProgressDialog();
                        Toast.makeText(Pon_search_view.this, "加载失败", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
...
//            Log.d("MainActivity", "COUNTY_ID is " + county.getCOUNTY_ID());
    ...
    private void showProgressDialog() {
        if (progressDialog == null) {
            progressDialog = new ProgressDialog(Pon_search_view.this);
